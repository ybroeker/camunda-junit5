...
public class MethodResourcesTest {

    @Deployment
    @Test
    void methodResource(final TestProcessEngine testProcessEngine) {
        ...
        Assertions.assertThat(deployedResources).containsExactly("MethodResourcesTest.methodResource.bpmn");
    }
